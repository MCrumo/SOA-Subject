...
.globl createthread; .type createthread, @function; .align 0; createthread:
 pushl %ebp
 movl %esp, %ebp
 pushl %ebx;
 pushl %ecx
...
.globl terminatethread; .type terminatethread, @function; .align 0; terminatethread:
 pushl %ebp
 movl %esp, %ebp
 movl $24, %eax
 call syscall_sysenter
...
.globl dump_screen; .type dump_screen, @function; .align 0; dump_screen:
 pushl %ebp
 movl %esp, %ebp
 pushl %ebx
 movl 0x8(%ebp), %ebx;
